        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 text-lg"
            >
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="w-full bg-gray-200 rounded-full h-4">
          <motion.div
            className="bg-gradient-to-r from-green-400 to-blue-500 h-4 rounded-full flex items-center justify-end pr-2"
            initial={{ width: 0 }}
