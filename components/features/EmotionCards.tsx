      ...
      <div className="space-y-6">
        ...
        <Card className="overflow-hidden">
          <CardContent className="p-0">
            <div
              className={`bg-gradient-to-br ${selectedEmotion.color} p-8 text-white text-center`}
            >
              <motion.div
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <Button
                  ...
                  onClick={() =>
                    speak(
                      `I feel ${selectedEmotion.name}. ${selectedEmotion.description}`
                    )
                  }
                  className="px-6"
                >
      ...
      <div className="text-center space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-600 text-lg">
            Tap on the emotion that matches how you feel
          </p>
        </div>
      </div>
